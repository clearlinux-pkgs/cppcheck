...
Version  : 2.9
Release  : 50
URL      : https://github.com/danmar/cppcheck/archive/2.9/cppcheck-2.9.tar.gz
Source0  : https://github.com/danmar/cppcheck/archive/2.9/cppcheck-2.9.tar.gz
...
%prep
%setup -q -n cppcheck-2.9
cd %{_builddir}/cppcheck-2.9
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661783757
mkdir -p clr-build
pushd clr-build
