...
Version  : 2.13.3
Release  : 66
URL      : https://github.com/danmar/cppcheck/archive/2.13.3/cppcheck-2.13.3.tar.gz
Source0  : https://github.com/danmar/cppcheck/archive/2.13.3/cppcheck-2.13.3.tar.gz
...
%prep
%setup -q -n cppcheck-2.13.3
cd %{_builddir}/cppcheck-2.13.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707414416
mkdir -p clr-build
pushd clr-build
