...
Version  : 2.13.4
Release  : 67
URL      : https://github.com/danmar/cppcheck/archive/2.13.4/cppcheck-2.13.4.tar.gz
Source0  : https://github.com/danmar/cppcheck/archive/2.13.4/cppcheck-2.13.4.tar.gz
...
%prep
%setup -q -n cppcheck-2.13.4
cd %{_builddir}/cppcheck-2.13.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708010447
mkdir -p clr-build
pushd clr-build
