...
Version  : 2.10.2
Release  : 56
URL      : https://github.com/danmar/cppcheck/archive/2.10.2/cppcheck-2.10.2.tar.gz
Source0  : https://github.com/danmar/cppcheck/archive/2.10.2/cppcheck-2.10.2.tar.gz
...
%prep
%setup -q -n cppcheck-2.10.2
cd %{_builddir}/cppcheck-2.10.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677513330
mkdir -p clr-build
pushd clr-build
