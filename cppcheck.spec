...
Version  : 2.14.2
Release  : 70
URL      : https://github.com/danmar/cppcheck/archive/2.14.2/cppcheck-2.14.2.tar.gz
Source0  : https://github.com/danmar/cppcheck/archive/2.14.2/cppcheck-2.14.2.tar.gz
...
%prep
%setup -q -n cppcheck-2.14.2
cd %{_builddir}/cppcheck-2.14.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718725525
mkdir -p clr-build
pushd clr-build
