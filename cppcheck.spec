...
Version  : 2.9.3
Release  : 53
URL      : https://github.com/danmar/cppcheck/archive/2.9.3/cppcheck-2.9.3.tar.gz
Source0  : https://github.com/danmar/cppcheck/archive/2.9.3/cppcheck-2.9.3.tar.gz
...
%prep
%setup -q -n cppcheck-2.9.3
cd %{_builddir}/cppcheck-2.9.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1669043017
mkdir -p clr-build
pushd clr-build
