...
Version  : 2.18.0
Release  : 78
URL      : https://github.com/danmar/cppcheck/archive/2.18.0/cppcheck-2.18.0.tar.gz
Source0  : https://github.com/danmar/cppcheck/archive/2.18.0/cppcheck-2.18.0.tar.gz
...
%prep
%setup -q -n cppcheck-2.18.0
cd %{_builddir}/cppcheck-2.18.0
pushd ..
cp -a cppcheck-2.18.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1753108544
mkdir -p clr-build
pushd clr-build
