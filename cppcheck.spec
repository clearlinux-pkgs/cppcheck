...
Version  : 2.10.1
Release  : 55
URL      : https://github.com/danmar/cppcheck/archive/2.10.1/cppcheck-2.10.1.tar.gz
Source0  : https://github.com/danmar/cppcheck/archive/2.10.1/cppcheck-2.10.1.tar.gz
...
%prep
%setup -q -n cppcheck-2.10.1
cd %{_builddir}/cppcheck-2.10.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676766804
mkdir -p clr-build
pushd clr-build
