...
Version  : 2.1
Release  : 28
URL      : https://github.com/danmar/cppcheck/archive/2.1/cppcheck-2.1.tar.gz
Source0  : https://github.com/danmar/cppcheck/archive/2.1/cppcheck-2.1.tar.gz
...
%prep
%setup -q -n cppcheck-2.1
cd %{_builddir}/cppcheck-2.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1592236972
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/cppcheck-2.1/COPYING %{buildroot}/usr/share/package-licenses/cppcheck/8624bcdae55baeef00cd11d5dfcfa60f68710a02
cp %{_builddir}/cppcheck-2.1/externals/simplecpp/LICENSE %{buildroot}/usr/share/package-licenses/cppcheck/49d4c0ce1a16601f1e265d446b6c5ea6b512f27c
pushd clr-build
%make_install
popd
