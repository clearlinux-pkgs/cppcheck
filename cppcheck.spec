...
Version  : 2.7.5
Release  : 46
URL      : https://github.com/danmar/cppcheck/archive/2.7.5/cppcheck-2.7.5.tar.gz
Source0  : https://github.com/danmar/cppcheck/archive/2.7.5/cppcheck-2.7.5.tar.gz
Summary  : No detailed summary available
Group    : Development/Tools
License  : BSD-2-Clause GPL-3.0 LGPL-3.0 MIT Zlib
...
%prep
%setup -q -n cppcheck-2.7.5
cd %{_builddir}/cppcheck-2.7.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1650123032
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/cppcheck-2.7.5/COPYING %{buildroot}/usr/share/package-licenses/cppcheck/8624bcdae55baeef00cd11d5dfcfa60f68710a02
cp %{_builddir}/cppcheck-2.7.5/externals/picojson/LICENSE %{buildroot}/usr/share/package-licenses/cppcheck/72d61ffe3f9c792cc8790c56aabe0f1a046d8c79
cp %{_builddir}/cppcheck-2.7.5/externals/simplecpp/LICENSE %{buildroot}/usr/share/package-licenses/cppcheck/49d4c0ce1a16601f1e265d446b6c5ea6b512f27c
cp %{_builddir}/cppcheck-2.7.5/externals/tinyxml2/LICENSE %{buildroot}/usr/share/package-licenses/cppcheck/409ff756b1f0bb05818f6ac0996facc6de1dc7d1
cp %{_builddir}/cppcheck-2.7.5/externals/z3-LICENSE %{buildroot}/usr/share/package-licenses/cppcheck/dad4e766bd1dda39916ad6d99a48f02c6884438a
pushd clr-build
%make_install
popd
...
/usr/share/package-licenses/cppcheck/dad4e766bd1dda39916ad6d99a48f02c6884438a
