...
Version  : 1.88
Release  : 25
URL      : https://github.com/danmar/cppcheck/archive/1.88/cppcheck-1.88.tar.gz
Source0  : https://github.com/danmar/cppcheck/archive/1.88/cppcheck-1.88.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1561963673
mkdir -p clr-build
pushd clr-build
