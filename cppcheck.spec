...
Version  : 2.6.3
Release  : 41
URL      : https://github.com/danmar/cppcheck/archive/2.6.3/cppcheck-2.6.3.tar.gz
Source0  : https://github.com/danmar/cppcheck/archive/2.6.3/cppcheck-2.6.3.tar.gz
...
%prep
%setup -q -n cppcheck-2.6.3
cd %{_builddir}/cppcheck-2.6.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1639676480
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/cppcheck-2.6.3/COPYING %{buildroot}/usr/share/package-licenses/cppcheck/8624bcdae55baeef00cd11d5dfcfa60f68710a02
cp %{_builddir}/cppcheck-2.6.3/externals/picojson/LICENSE %{buildroot}/usr/share/package-licenses/cppcheck/72d61ffe3f9c792cc8790c56aabe0f1a046d8c79
cp %{_builddir}/cppcheck-2.6.3/externals/simplecpp/LICENSE %{buildroot}/usr/share/package-licenses/cppcheck/49d4c0ce1a16601f1e265d446b6c5ea6b512f27c
cp %{_builddir}/cppcheck-2.6.3/externals/tinyxml2/LICENSE %{buildroot}/usr/share/package-licenses/cppcheck/409ff756b1f0bb05818f6ac0996facc6de1dc7d1
cp %{_builddir}/cppcheck-2.6.3/externals/z3-LICENSE %{buildroot}/usr/share/package-licenses/cppcheck/dad4e766bd1dda39916ad6d99a48f02c6884438a
pushd clr-build
%make_install
popd
